...
import logoDark from '../../assets/images/wiz-resale-logo-dark.png'
const Footer = () => {
    return (
        <footer className="footer mt-[100px] items-center p-12 bg-[#242424] text-neutral-content">
            <div>
                <img src={logoDark} alt="Wiz Resale" /> <br />
